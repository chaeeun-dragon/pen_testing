...
import com.bookwave.lab.mockpg.api.ErrorResponse;
...
public class MockPgExceptionHandler {

    @ExceptionHandler(MockPgException.class)
    ResponseEntity<ErrorResponse> handle(MockPgException ex, HttpServletRequest request) {
